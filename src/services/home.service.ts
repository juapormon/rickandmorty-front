...
import { CharacterFromAPI, CharactersFromAPI } from 'types/models/character.types';
import { EpisodeFromAPI, EpisodesFromAPI } from 'types/models/episode.types';
import { LocationFromAPI, LocationsFromAPI } from 'types/models/location.types';
